export const APP_COPY = {
  ...
  parkTab: 'Parks',
  countyTab: 'Counties',
  mobileSearchPlaceholder: 'Tap map or search',
...
export const MAP_COPY = {
  ...
  allParksMobile: 'All',
  nationalParksMobile: 'National',
  stateParksMobile: 'State',
  legendTitle: 'Legend',
  legendSizeNote: 'Monthly visits',
  legendColorNote: 'Change vs before COVID-19',
  belowBaseline: 'Below baseline',
  atBaseline: 'At baseline',
  aboveBaseline: 'Above baseline',
  legendButton: 'Legend',
